...
export const LoginPage = ({ startGoogleLogin, startFacebookLogin, startGithubLogin }) => (
    <div className="box-layout">
        <div className="box-layout__box">
            ...
            <button className="button button--margin" onClick={startGoogleLogin}>Login with Google</button>
            <button className="button button--margin" onClick={startFacebookLogin}>Login with Facebook</button>
